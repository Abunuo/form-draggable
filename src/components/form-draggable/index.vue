 ...
 * @Description: 拖拽组件模板
 * @use： <form-draggable v-model="formList"></form-draggable>
-->
<template>
...
<script setup>
	...
	import { defineEmit, defineProps, reactive, ref, watch } from '@vue/runtime-core'
	...
	const add = component => {
		...
		const index = templateData.findIndex(item => item == state.activeComponent)
